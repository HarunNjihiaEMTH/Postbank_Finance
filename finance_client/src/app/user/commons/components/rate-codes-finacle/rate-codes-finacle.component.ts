...
@Component({
  selector: 'app-rate-codes-finacle',
  templateUrl: './rate-codes-finacle.component.html',
  styleUrls: ['./rate-codes-finacle.component.scss']
})
export class RateCodesFinacleComponent extends BaseComponent
implements OnInit {

//   {
//     "rateDesc": "CROSS CURRENCY BUYING",
//     "rateCode": "CNB"
// }
displayedColumns: string[] = ["rateCode", "rateDesc"];
...
getRateCodes() {
  this.isLoading = true;
  this.uraService
    .listAllFinacleRateCodes()
    .pipe(takeUntil(this.subject))
    .subscribe(
      (res) => {
        this.rateCodes = res;

        console.log("rateCodes: ", this.rateCodes);
        ...
        this.dataSource = new MatTableDataSource<Invoice>(this.rateCodes);
