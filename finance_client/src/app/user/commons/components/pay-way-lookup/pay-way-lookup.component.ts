...
@Component({
  selector: 'app-pay-way-lookup',
  templateUrl: './pay-way-lookup.component.html',
  styleUrls: ['./pay-way-lookup.component.sass']
})
export class PayWayLookupComponent extends BaseComponent implements OnInit {
  ...
  getPayWays() {
    this.uraService
      ...
      .subscribe(
        (res) => {
          console.log(res);
          this.payWays = res.body;

          if (this.payWays) {
            this.isLoading = false;

            this.dataSource = new MatTableDataSource<Item>(this.payWays);
