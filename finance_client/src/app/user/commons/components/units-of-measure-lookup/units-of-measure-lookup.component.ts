...
@Component({
  selector: 'app-units-of-measure-lookup',
  templateUrl: './units-of-measure-lookup.component.html',
  styleUrls: ['./units-of-measure-lookup.component.sass']
})
export class UnitsOfMeasureLookupComponent extends BaseComponent implements OnInit {
      ...
      .subscribe(
        (res) => {
          ...
          if (this.unitsOfMeasure) {
            ...
            this.dataSource = new MatTableDataSource<Item>(this.unitsOfMeasure);
