...
export class TaxesLookupComponent extends BaseComponent implements OnInit {
      ...
      .subscribe(
        (res) => {
          ...
          if (this.taxCategories) {
            ...
            this.dataSource = new MatTableDataSource<Item>(this.taxCategories);
