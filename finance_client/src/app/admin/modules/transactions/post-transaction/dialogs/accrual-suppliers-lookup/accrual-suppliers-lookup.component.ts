...
@Component({
  selector: 'app-accrual-suppliers-lookup',
  templateUrl: './accrual-suppliers-lookup.component.html',
  styleUrls: ['./accrual-suppliers-lookup.component.sass']
})
export class AccrualSuppliersLookupComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<AccrualSuppliersLookupComponent>,
  ...
  ngOnInit(): void {
    ...
    console.log("this.expenses: ", this.supplierDetails);
