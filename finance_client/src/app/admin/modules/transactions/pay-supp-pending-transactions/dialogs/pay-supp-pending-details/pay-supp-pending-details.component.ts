...
@Component({
  selector: "app-pay-supp-pending-details",
  templateUrl: "./pay-supp-pending-details.component.html",
  styleUrls: ["./pay-supp-pending-details.component.sass"],
})
export class PaySuppPendingDetailsComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<PaySuppPendingDetailsComponent>,
