...
@Component({
  selector: 'app-rejected-transactions-supplier',
  templateUrl: './rejected-transactions-supplier.component.html',
  styleUrls: ['./rejected-transactions-supplier.component.sass']
})
export class RejectedTransactionsSupplierComponent implements OnInit {
