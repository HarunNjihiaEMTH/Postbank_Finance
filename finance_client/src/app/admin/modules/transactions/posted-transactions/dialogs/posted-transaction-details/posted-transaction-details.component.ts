...
@Component({
  selector: "app-posted-transaction-details",
  templateUrl: "./posted-transaction-details.component.html",
  styleUrls: ["./posted-transaction-details.component.sass"],
})
export class PostedTransactionDetailsComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<PostedTransactionDetailsComponent>,
