...
@Component({
  selector: 'app-general-cost-centers-lookup',
  templateUrl: './general-cost-centers-lookup.component.html',
  styleUrls: ['./general-cost-centers-lookup.component.sass']
})
export class GeneralCostCentersLookupComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log("this.expenses: ", this.costCenterDetails);
