...
import { TransactionReportComponent } from './pages/all-minis/accruals/transaction-report/transaction-report.component';
import { TransactionParamsComponent } from './pages/all-minis/accruals/transaction-report/dialog/transaction-params/transaction-params.component';

import { DirectTransactionsComponent } from './pages/all-minis/direct-transactions/direct-transactions.component';
import { DirectTransParamsComponent } from './pages/all-minis/direct-transactions/dialog/direct-trans-params/direct-trans-params.component';
...
@NgModule({
  declarations: [
    ...
    DirectTransactionsComponent,
    DirectTransParamsComponent,
