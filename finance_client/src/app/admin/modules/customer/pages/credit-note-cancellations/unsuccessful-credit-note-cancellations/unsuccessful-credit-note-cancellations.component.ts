...
@Component({
  selector: 'app-unsuccessful-credit-note-cancellations',
  templateUrl: './unsuccessful-credit-note-cancellations.component.html',
  styleUrls: ['./unsuccessful-credit-note-cancellations.component.sass']
})
export class UnsuccessfulCreditNoteCancellationsComponent extends BaseComponent implements OnInit {
  ...
  getInvoices() {
    ...
    this.creditNoteCancellationService
      .fetchFailedCreditNotesCancellation()
