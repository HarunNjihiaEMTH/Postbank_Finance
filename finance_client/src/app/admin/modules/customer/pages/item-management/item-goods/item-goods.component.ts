...
@Component({
  selector: 'app-item-goods',
  templateUrl: './item-goods.component.html',
  styleUrls: ['./item-goods.component.sass']
})
export class ItemGoodsComponent extends BaseComponent implements OnInit {
  items: Item[] = [];
