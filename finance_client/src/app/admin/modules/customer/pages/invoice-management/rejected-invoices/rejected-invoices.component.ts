...
@Component({
  ...
  styleUrls: ["./rejected-invoices.component.sass"],
})
export class RejectedInvoicesComponent extends BaseComponent implements OnInit {
  ...
  navigateToInvoiceDetails(invoiceno) {
    this.router.navigate(
      [`/user/customer/invoices-management/invoice-information/${invoiceno}`],
      {
        state: {
          action: "Navigation From Rejected Invoices",
        },
      }
    );
  }
  ...
  navigateToGenerateInvoice() {
    this.router.navigate([
      "/user/customer/invoices-management/generate-invoice",
    ]);
  }

  updateInvoice(invoice) {
    this.router.navigate(
      ["/user/customer/invoices-management/update-invoice"],
      {
        state: {
