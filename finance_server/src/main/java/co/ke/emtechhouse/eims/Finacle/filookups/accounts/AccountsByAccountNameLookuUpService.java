...
@Service
@Slf4j
public class AccountsByAccountNameLookuUpService {
    Configurations cn = new Configurations();
    String url = cn.getProperties().getProperty("fin.url");
    Utils utils = new Utils();

    public String fetchAcountsByAccountName(String accountName )
    {
        ...
        String xml = "<?xml version=\"1.0\"?>\n" +
                ...
                "                <requestId>acct_list_by_acct_name.scr</requestId>\n" +
                "            </ExecuteFinacleScriptInputVO>\n" +
